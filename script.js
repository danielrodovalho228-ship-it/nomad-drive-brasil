...
const I18N = {
  en: {
    ...
    "antifit.title": "We're not for everyone — and that's OK",
    "antifit.sub": "Worth being upfront. This doesn't make sense for someone who:",
    "antifit.1": "Only wants the cheapest possible price — a local rental is the better fit",
    "antifit.2": "Needs a car for 3–7 days — a daily rate from a local agency wins",
    "antifit.3": "Lives in Uberlândia and speaks Portuguese — you won't use our differentiators",
    "antifit.4": "Plans to drive a lot (5,000+ km/month) — outside our fair-use range",
    "antifit.yes": "For everyone else — international traveler, 1+ month stay, wants peace of mind and support in English or Spanish — we're the obvious choice.",
    ...
    "compare.honest": "Yes — we're ~R$ 770 pricier on the Cronos. On purpose. That extra pays for EN/ES support, in-person handover, no queue, and km fair-use. If you just want the cheapest, go straight to the local rental — no hard feelings.",
  ...
  pt: {
    ...
    "antifit.title": "Não somos pra todo mundo — e tá tudo bem",
    "antifit.sub": "Vale a pena ser honesto. Esse serviço não faz sentido pra quem:",
    "antifit.1": "Só quer o mais barato possível — locadora local resolve melhor",
    "antifit.2": "Precisa de carro por 3–7 dias — diária de locadora compensa mais",
    "antifit.3": "Mora em Uberlândia e fala português — não vai usar nosso diferencial",
    "antifit.4": "Vai rodar muito (5.000+ km/mês) — fora da nossa franquia",
    "antifit.yes": "Pra todo o resto — viajante internacional, estadia 1+ mês, quer paz e suporte em inglês ou espanhol — somos a escolha óbvia.",
    ...
    "compare.honest": "Sim — somos ~R$ 770 a mais no Cronos. É de propósito. Esse extra paga suporte em inglês/espanhol, entrega em mãos, sem fila e quilometragem livre. Se você só quer o mais barato, vai direto na locadora local — sem rancor.",
  ...
  es: {
    ...
    "antifit.title": "No somos para todos — y está bien",
    "antifit.sub": "Vale la pena ser honesto. Este servicio no tiene sentido para quien:",
    "antifit.1": "Solo quiere lo más barato posible — una agencia local resuelve mejor",
    "antifit.2": "Necesita auto por 3–7 días — la diaria de una agencia local compensa más",
    "antifit.3": "Vive en Uberlândia y habla portugués — no va a usar nuestros diferenciales",
    "antifit.4": "Va a manejar mucho (5.000+ km/mes) — fuera de nuestro fair use",
    "antifit.yes": "Para todo el resto — viajero internacional, estadía de 1+ mes, quiere paz y soporte en inglés o español — somos la elección obvia.",
    ...
    "compare.honest": "Sí — somos ~R$ 770 más caros en el Cronos. A propósito. Ese extra paga soporte en inglés/español, entrega en mano, sin fila y kilometraje libre. Si solo querés lo más barato, andá directo a la agencia local — sin rencores.",
