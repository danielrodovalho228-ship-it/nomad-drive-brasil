...
const I18N = {
  en: {
    ...
    "hero.stat4v": "Free km",
    "hero.stat4": "fair use 3,000 km/mo · no penalty",
    ...
    "strip.6": "✓ Free mileage (fair use)",
    "antifit.title": "Built for you if…",
    "antifit.sub": "A short read to see if we fit your trip. We're a curated network for a specific kind of traveler:",
    "antifit.1": "You're visiting Brazil from abroad for one month or more",
    "antifit.2": "You value English or Spanish support during your stay",
    "antifit.3": "You want the car handed over in person — no airport counter queue",
    "antifit.4": "You like the idea of renting from a real owner (not a corporate fleet) who earns a fair passive income from sharing the car",
    "antifit.yes": "Sound like you? Then we're a great match. Every car in the network is shared by an owner we trust — your rental helps them generate a fair, ethical income, and you get a car that's actually cared for.",
    ...
    "compare.r2": "Mileage overage", "compare.r2v": "Charged per km", "compare.r2us": "Fair use, no penalty",
    ...
    "compare.honest": "Our model includes what makes a long trip smoother: EN/ES support, in-person handover at your arrival time, no counter queue, and free mileage. And every car here is owned by a real person in our network — cared for personally, not rotated through a corporate fleet. That care reaches you.",
  ...
  pt: {
    ...
    "hero.stat4v": "Km livre",
    "hero.stat4": "fair use 3.000 km/mês · sem multa",
    ...
    "strip.6": "✓ Quilometragem livre (fair use)",
    "antifit.title": "Feito pra você se…",
    "antifit.sub": "Uma leitura curta pra ver se a gente combina com sua viagem. Somos uma rede curada pra um perfil específico de viajante:",
    "antifit.1": "Está vindo do exterior pra ficar 1 mês ou mais no Brasil",
    "antifit.2": "Valoriza suporte em inglês ou espanhol durante a estadia",
    "antifit.3": "Quer o carro entregue em mãos — sem fila de balcão no aeroporto",
    "antifit.4": "Gosta da ideia de alugar de um dono real (não de uma frota corporativa) que gera uma renda passiva justa compartilhando o carro",
    "antifit.yes": "Combinou? Então a gente é a escolha certa. Cada carro da rede é compartilhado por um dono em quem confiamos — seu aluguel ajuda essa pessoa a gerar uma renda passiva justa, e você ganha um carro de verdade cuidado.",
    ...
    "compare.r2": "Excedente de km", "compare.r2v": "Cobrado por km", "compare.r2us": "Fair use, sem multa",
    ...
    "compare.honest": "Nosso modelo inclui o que faz uma viagem longa ser mais tranquila: suporte em inglês/espanhol, entrega em mãos no horário que você chegar, sem fila de balcão e quilometragem livre. E cada carro aqui é de uma pessoa real da nossa rede — cuidado pessoalmente, não rodando numa frota corporativa. Esse cuidado chega em você.",
  ...
  es: {
    ...
    "hero.stat4v": "Km libre",
    "hero.stat4": "fair use 3.000 km/mes · sin multa",
    ...
    "strip.6": "✓ Kilometraje libre (fair use)",
    "antifit.title": "Hecho para vos si…",
    "antifit.sub": "Una lectura corta para ver si encajamos en tu viaje. Somos una red curada para un perfil específico de viajero:",
    "antifit.1": "Estás visitando Brasil desde el exterior por 1 mes o más",
    "antifit.2": "Valorás soporte en inglés o español durante la estadía",
    "antifit.3": "Querés el auto entregado en mano — sin fila de mostrador en el aeropuerto",
    "antifit.4": "Te gusta la idea de alquilar a un dueño real (no a una flota corporativa) que genera un ingreso pasivo justo compartiendo el auto",
    "antifit.yes": "¿Te identificás? Entonces somos buena elección. Cada auto de la red es compartido por un dueño en quien confiamos — tu alquiler ayuda a esa persona a generar un ingreso pasivo justo, y vos te llevás un auto realmente cuidado.",
    ...
    "compare.r2": "Exceso de km", "compare.r2v": "Cobrado por km", "compare.r2us": "Fair use, sin multa",
    ...
    "compare.honest": "Nuestro modelo incluye lo que hace una estadía larga más tranquila: soporte en inglés/español, entrega en mano al horario que llegás, sin fila de mostrador y kilometraje libre. Y cada auto aquí es de una persona real de nuestra red — cuidado en persona, no rotando en una flota corporativa. Ese cuidado te llega a vos.",
